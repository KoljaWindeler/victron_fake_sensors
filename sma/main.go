...
func main() {
	...
	victronValues[0]["/CustomName"] = dbus.MakeVariant("SMA inverter")
	victronValues[1]["/CustomName"] = dbus.MakeVariant("SMA inverter")
	...
	// also in system.py
	victronValues[0]["/ProductName"] = dbus.MakeVariant("SMA")
	victronValues[1]["/ProductName"] = dbus.MakeVariant("SMA")

	victronValues[0]["/Serial"] = dbus.MakeVariant("SMA123456")
	victronValues[1]["/Serial"] = dbus.MakeVariant("SMA123456")
	...
	reply, err := conn.RequestName("com.victronenergy.pvinverter.SMA",
	...
	log.Info("Successfully connected to dbus and registered as a pvinverter... Commencing reading SMA")
...
var messagePubHandler mqtt.MessageHandler = func(client mqtt.Client, msg mqtt.Message) {
	...
	// Power
	if ContainString(".*sma/power$", msg.Topic()) {
	...
	// /Ac/Energy/Forward
	if ContainString(".*sma/yield$", msg.Topic()) {
