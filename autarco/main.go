...
var (
	broker     = "192.168.2.8"
	brokerPort = 1883
	topic1      = "dev66/r/autarco_power"
	topic2      = "dev66/r/autarco_kwh"
	clientId   = "autarco-bridge"
	username   = "ha"
	password   = "ah"
)
...
func main() {
	...
	victronValues[0]["/CustomName"] = dbus.MakeVariant("Autarco inverter")
	victronValues[1]["/CustomName"] = dbus.MakeVariant("Autarco inverter")
	...
	// also in system.py
	victronValues[0]["/Mgmt/Connection"] = dbus.MakeVariant("/dev/ttyUSB1")
	victronValues[1]["/Mgmt/Connection"] = dbus.MakeVariant("/dev/ttyUSB1")
	...
	// also in system.py
	victronValues[0]["/ProductName"] = dbus.MakeVariant("Autarco")
	victronValues[1]["/ProductName"] = dbus.MakeVariant("Autarco")

	victronValues[0]["/Serial"] = dbus.MakeVariant("AT123456")
	victronValues[1]["/Serial"] = dbus.MakeVariant("AT123456")
	...
	reply, err := conn.RequestName("com.victronenergy.pvinverter.autarco",
	...
	log.Info("Successfully connected to dbus and registered as a pvinverter... Commencing reading autarco")
...
var messagePubHandler mqtt.MessageHandler = func(client mqtt.Client, msg mqtt.Message) {
	...
	// Power
	if ContainString(".*dev66/r/autarco_power$", msg.Topic()) {
	...
	// /Ac/Energy/Forward
	if ContainString(".*dev66/r/autarco_kwh$", msg.Topic()) {
